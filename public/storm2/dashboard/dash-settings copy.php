...
BUY
-->
<div class="dash_settings" id="settings_buy" style="display:flex;">
<div class="dash_settings_title"><i class="fa-solid fa-arrow-left" onClick="dash_settings_close()"></i> Buy Settings</div>

<form>

<ul>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy1()"></i><span>Text</span></div>Buy GWEI</label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy2()"></i><span>Text</span></div>Approve GWEI </label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy3()"></i><span>Text</span></div>Sell GWEI</label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy4()"></i><span>Text</span></div>Anti-Rug GWEI</label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy5()"></i><span>Text</span></div>Buy Tax Limit</label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy6()"></i><span>Text</span></div>Sell Tax Limit</label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy7()"></i><span>Text</span></div>Min Liquidity Limit</label><input type="text" placeholder="0.01 ETH"></li>
<li><label><div><i class="fa-solid fa-circle-info" onClick="buy8()"></i><span>Text</span></div>Max Liquidity Limit</label><input type="text" placeholder="0.01 ETH"></li>
</ul>

<input type="submit" value="Save">

<div class="dash_settings_help">
<span id="buy1">
<b>Buy GWEI</b>
