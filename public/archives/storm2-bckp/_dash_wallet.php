...
<div class="settings_bloc_title"><?= $latrad['Settings']['fr'] ?>Settings <i class="fa-solid fa-xmark" onClick="settings_close()"></i></div>
...
<div><a class="on">Default wallet<i class="fa-solid fa-check"></i></a><a>Sniper Wallet<i class="fa-solid fa-check"></i></a><a>Buy, Sell Wallet<i class="fa-solid fa-check"></i></a></div>
</li>
<li class="dash_settings_wallets">
...
<div><a>Default wallet<i class="fa-solid fa-check"></i></a><a class="on">Sniper Wallet<i class="fa-solid fa-check"></i></a><a>Buy, Sell Wallet<i class="fa-solid fa-check"></i></a></div>
</li>
<li class="dash_settings_wallets">
...
<div><a class="on">Default wallet<i class="fa-solid fa-check"></i></a><a class="on">Sniper Wallet<i class="fa-solid fa-check"></i></a><a>Buy, Sell Wallet<i class="fa-solid fa-check"></i></a></div>
</li>
<li class="dash_settings_wallets">
...
<div><a>Default wallet<i class="fa-solid fa-check"></i></a><a>Sniper Wallet<i class="fa-solid fa-check"></i></a><a class="on">Buy, Sell Wallet<i class="fa-solid fa-check"></i></a></div>
</li>
