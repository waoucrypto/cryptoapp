...
<li class="w100b">
<div class="wallet_import2_img"><?= $latrad["Step 1"][$_SESSION['langue']] ?><img src="/storm/images/privatekey1.gif"></div>
<div class="wallet_import2_img"><?= $latrad["Step 2"][$_SESSION['langue']] ?><img src="/storm/images/privatekey2.gif"></div>
<div class="wallet_import2_img"><?= $latrad["Step 3"][$_SESSION['langue']] ?><img src="/storm/images/privatekey3.gif"></div>
</li>
</form>
</div>
