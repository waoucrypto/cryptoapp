...
<a href="/storm2/dashboard/" class="on"><?= $latrad["Dashboard"][$_SESSION['langue']] ?> <i class="fa-solid fa-chart-simple"></i></a>
<a href="/storm2/bot/"><?= $latrad["Web Bot"][$_SESSION['langue']] ?> <i class="fa-solid fa-robot"></i></a>
