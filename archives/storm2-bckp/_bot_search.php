...
<i class="faslash" id="open_bot_search_menu">/</i>
...
$(document).ready(function() {
	...
	$('#open_bot_search_menu').on('click', function() {
		setTimeout(function() {
	...
	function handleMenuClick(selector, loadFile) {
		$(document).on('click', selector, function(e) {
			...
			if (loadFile === '_search.php') {
				loadContentWithLoader(newStorm, '_search.php', null, '.search_bloc input[type="text"]');
			} else {
				loadContentWithLoader(newStorm, loadFile);
			}
		});
    ...
    var menuItems = [
        { selector: '.bot_search #latest', loadFile: '_dash_latest.php' },
        { selector: '.bot_search #trending', loadFile: '_dash_trending.php' },
        { selector: '.bot_search #buy', loadFile: '_bot_snipe.php' },
        { selector: '.bot_search #profit', loadFile: '_dash_profit.php' },
        { selector: '.bot_search #portfolio', loadFile: '_dash_portfolio.php' },
        { selector: '.bot_search #performance', loadFile: '_dash_performance.php' },
        { selector: '.bot_search #wallet', loadFile: '_dash_wallet.php' }, 
        { selector: '.bot_search #token', loadFile: '_bot_token.php' },
		...
		{ selector: '.bot_side_center ul li a#token', loadFile: '_bot_token.php' },
		{ selector: '.bot_search a#searchh', loadFile: '_search.php' },
		{ selector: '.bot .bot_message a#searchh', loadFile: '_search.php' },
    ];
    ...
    function handleTokenInput(token) {
    	...
    	$('#searchInput').val('');
		loadContentWithLoader(newStorm, '_bot_token.php');
    }
