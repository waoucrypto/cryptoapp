...
<em>
<b>Share</b>
<a href="https://twitter.com/intent/tweet?url=https://apicrypt.cryptomoonitor.com/storm2/twitter.php?code=PEPE_tc=1ETH_pr=300&text=Regardez+mon+image" target="_blank"><i class="fa-brands fa-x-twitter"></i></a>
...
function updateShareLinks(imageUrl) {
    ...
    $('#twitterShare').attr('href', `https://twitter.com/intent/tweet?url=https://apicrypt.cryptomoonitor.com/storm2/twitter.php?code=PEPE_tc=1ETH_pr=300&text=Regardez+mon+image`);
    $('#telegramShare').attr('href', `https://telegram.me/share/url?url=https://apicrypt.cryptomoonitor.com/storm2/${encodedImageUrl}&text=Regardez+mon+image`);
    $('#facebookShare').attr('href', `https://www.facebook.com/sharer/sharer.php?u=https://apicrypt.cryptomoonitor.com/storm2/${encodedImageUrl}`);
    $('#whatsappShare').attr('href', `https://api.whatsapp.com/send?text=Regardez+mon+image https://apicrypt.cryptomoonitor.com/storm2/${encodedImageUrl}`);
}
