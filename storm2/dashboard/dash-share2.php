...
$domain = 'https://apicrypt.cryptomoonitor.com/'; // Remplacez avec votre nom de domaine réel
$upload_dir = "uploads/"; // Assurez-vous que ce dossier est accessible depuis le Web
$upload_path = $_SERVER['DOCUMENT_ROOT'] . '/' . $upload_dir; // Chemin absolu du dossier sur le serveur
